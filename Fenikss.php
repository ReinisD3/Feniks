...
$symbolsForAlphabet = ['A','B','C','D','E'];
$alphabetLineValues = ['A' => 15 , 'B' => 10, 'C'=> 5, 'D' => 20 , 'E' => 100];
$Alphabet = new SlotMachine("Letter Spiner ABDCD ",$betKoeficenti,$symbolsForAlphabet,$alphabetLineValues,$definedWinsforColumns3x3);
$Alphabet->setRowsColumns(3,3);

$symbolsForDigit = ['1','2','3','4','5'];
$digitLineValues = ['1' => 25 , '2' => 10, '3'=> 25, '4' => 15 , '5' => 15];
$Digit = new SlotMachine('DigitMaster 12345',$betKoeficenti,$symbolsForDigit,$digitLineValues);

$symbolsForRandom = ['@','!','*','%','$'];
$randomLineValues = ['@' => 55 , '!' => 100, '*'=> 20, '%' => 10, '$' => 10];
$Random = new SlotMachine('Random character finder $%!@&',$betKoeficenti,$symbolsForRandom,$randomLineValues);
